...
#define STRING_CONFIG_H_AUTHOR "(SHAPENERD, Predator TMC2130 SKR-V1.3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Anycubic Predator SKR1.3"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //PREDATOR STOCK BED w/ ULTRABASE
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    //#define DELTA_CALIBRATION_RADIUS 175 // (mm)
